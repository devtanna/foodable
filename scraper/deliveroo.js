    ...
    try {
        ...
        $('li[class*="HomeFeedGrid"]', html).each(function() {
            ...
            let result ={
                ...
                slug: utils.slugify($('div[class*="RestaurantCard"] span p', this).eq(0).text().trim()),
            ...
            if (result.offer.length > 0 ){
                ...
                if (obj == undefined){ // dont want to push duplicates
                    items.push(
                        result
                    );
                }
...
const run = async () => {
    ...
    console.log("Deliveroo: Scraped deliveroo. Results count: "+mergedResults.length);
